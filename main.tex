...
\WorkEntry{Software tester}{2023-present}{Nordic Semiconductor}{
    I tested tools on nRF Development Kits using pytest+Jenkins.
...
\WorkEntry{Software developer}{2020-2023}{Nordic Semiconductor}{
    I developed CLI tools in Rust/Python/C++ on Ubuntu/Windows/MacOS.
...
% Terse version of SINTEF
 ...
 I made a Python tool for translating output in hdf5 format.
...
I developed a BLE Mesh simulator using Python and tkinter
...
\WorkEntry{Teaching assistant}{2017-2020}{NTNU Part-time}
{I aided students in designing completing exercises in multiple courses, involving LabView, Kalman filters, distributed Erlang/Elixir/Go, TCP/UDP, Matlab/Simulink and C++.}
