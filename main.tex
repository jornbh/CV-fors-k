...
\SkillsEntry{Software}{Rust, C++, Python, Elixir, Docker, Jenkins}
...
The tests were done both on FPGAs and directly on hardware. I also helped to make the CI/CD system using Jenkins/Bash for building and testing and the Docker images we needed to run on the FPGAs. 
...
One of the tools was a bundler for making an isolated toolchain used for working with the nRF SDK. The tool greatly simplified the initial installation for our first-time users and increasing reproducability for customer support.  
