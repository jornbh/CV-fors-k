...
\EducationEntry{Develop and maintain tooling for working with Nordic devices}{2020-present}{Nordic Semiconductor}{
...
The job also involved building and testing systems for Continuous Integration and Delivery.

% ##Things I have done in Nordic
% - testing device-lib 
% - toolchain-bundler 
% 	- Building and releasing the toolchiain bundles until another team was able to take the job in CI 
...
\EducationEntry{Making a tool for comparing hydropower-production}{Summer 2019}{SINTEF Energy}{
...
{I aided students in controling a model helicopter using a linear multivariable regulator and a Kalman-filter to estimate state.
}
