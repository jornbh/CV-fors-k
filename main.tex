...
\EducationEntry{Software tester}{2023-present}{Nordic Semiconductor}{
I provided test coverage as well as automated Jenkins CI/CD systems using a Python framework to interact test operations like flashing, reseting and erasing on Nordic Semiconductor's microcontrollers. As well as testing the new security features on our newer chips. 
}
\EducationEntry{Made tooling for developing on microcontrollers}{2020-2023}{Nordic Semiconductor}{
% Short 	
...
I developed cross-platform command-line tools in Rust facilitating development on Nordic Semiconductor's microcontrollers, maintained tooling in C++ and Python. Developed on Linux, Windwos and MacOS.  
...
{
I assisted students in exercises involving circuits with complex impedance, as well as lab-work where they had to control and inverted pendulum with a PID controller. 
