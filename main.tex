...
{I helped to increase our customer's confidence in our products by testing our tools made to do DFUs and resetting Nordic Semiconductor's devices.
...
-  A tool for making an isolated toolchain for developing with the nRF SDK. This tool heavily used async to get a doubling in speed. 
\par 
...
\WorkEntry{Teaching assistant (TDT4102 - Procedural and Object-Oriented Programming)}{Spring 2017}{NTNU Part-time}
{I helped students learn the basics of C++, object-oriented programming, templates and pointers/smart-ponters. 
}
