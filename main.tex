...
\EducationEntry{Developed infrastructeure for Contineous Integration and software}{2023-present}{Nordic Semiconductor}{
I developed Continuous integration systems for Nordic's software using Jenkins.  
}

\EducationEntry{Developed and maintained tooling for working with Nordic devices}{2020-2023}{Nordic Semiconductor}{
I developed cross-platform tooling for developing for Nordic Semiconductor devices. 
This included profiling and parallelizing Rust, Python and Bash programs. 
...
% {Assisting students in designing a robust distributed system, controlling a set of model elevators in an unreliable network using unreliable hardware.}
