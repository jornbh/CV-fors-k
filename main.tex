...
This included profiling and paralelizing  Rust, Python and Bash programs. 
The job also involved making build and test systems for Contineous Integration and Delivery.

% ##Things I have done in Nordic
% - testing device-lib 
% - toolchain-bundler 
% 	- Building and releasing the toolchiain bundles until another team were able to take the job in CI 
% 	- Parallelizing and simplifying for performande gains
% - pc-ble-driver-py 
% - nrfutil 
% - azure pipelines 
% - nrfutil completion
