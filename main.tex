...
{Providing assistance students in designing a robust distributed system, controlling a set of model elevators taking orders. The system was supposed function even under limited handle hardware failures and handle network issues}
